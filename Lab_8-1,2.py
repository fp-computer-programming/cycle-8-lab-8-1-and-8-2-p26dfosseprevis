...
#Write a function in that uses the for loop and the range function to find the sum of all the numbers up 
#to and including the number the user input
...
def two(x):
    ...
    z = []
    for y in x:
        z += [f"Hi {y}, You're invited to my party on Friday!"]
    return z

print(two(["Sans","Dylan","Frank","Sean"]))